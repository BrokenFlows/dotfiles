...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  hi Normal           ctermbg=235  ctermfg=253  guibg=#262626 guifg=#bcbcbc cterm=NONE           gui=NONE
  hi Terminal         ctermbg=235  ctermfg=253  guibg=#262626 guifg=#bcbcbc cterm=NONE           gui=NONE
